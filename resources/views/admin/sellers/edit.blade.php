...
<div class="fcol bg-teal txt-white centered py-2 sticky-top">
   ...
   <div class="frow"> <a href="{{url('admin')}}" class="hover-orange"> Home </a> <span class="mx-2">/</span>
      <a href="{{route('sellers.index')}}" class="hover-orange"> Sellers list </a> <span class="mx-2">/</span> Edit
   </div>
...
<div class="frow centered">
   <div class="fcol w-60">
      ...
      <div class="w-100 bg-light px-4 pb-2 my-4 border-left border-2 border-success">
         <div class="txt-b txt-orange">Edit seller</div>
            ...
            <div class="fcol stretched mt-3">
               <div class="frow stretched">
                  <div class="fancyinput w-48">
                     <input type="text" name='name' placeholder="Enter seller name" value="{{$seller->name}}" required>
                     <label for="Name">Name</label>
                  </div>
                  <div class="fancyinput w-48">
                     <input type="text" name='phone' placeholder="03001234567" value="{{$seller->phone}}" required>
                     <label for="Name">Phone</label>
                  </div>
               </div>
               <div class="fancyinput w-100 mt-3">
                  <input type="text" name='address' placeholder="ABC Commission Shop, Lahore" value="{{$seller->address}}" required>
