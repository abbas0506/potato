...
<div class="flexrow row-mid-left txt-m txt-white bg-teal px-5 py-2">
   <div><i data-feather='layers' class="feather-small mx-2"></i>Data Verification - Form No {{$registration->id}}</div>
</div>
...
<form action="{{route('scrutiny.update', $registration->id)}}" method='post'>
   ...
   <div class="flexrow mt-3 px-10 auto-col" style='font-size:1.15rem;'>
      <div class="flexcol hw-40">
         <div class='mb-1'><input type="checkbox" name='haspics' value='1' class='chk' checked> &nbsp &nbsp Pics</div>
         <div class='mb-1'><input type="checkbox" name='hasgcnic' value='1' class='chk' checked> &nbsp &nbsp Guardian CNIC</div>
         <div class='mb-1'><input type="checkbox" name='hasbform' value='1' class='chk' checked> &nbsp &nbsp B Form</div>
         <div class='mb-1'><input type="checkbox" name='hasmatric' value='1' class='chk' checked> &nbsp &nbsp Matric Result</div>
         @if($registration->isOtherBoard())
         <div class='mb-1'><input type="checkbox" name='hasnoc' class='chk' value='1' checked> &nbsp &nbsp NOC</div>
         @endif
      </div>
      <div class="flexcol hw-60">
         <div class='mb-1'><input type="checkbox" name='isdobcorrect' value='1' class='chk' checked> &nbsp &nbsp Date of birth correct? <span class='txt-s'>(optional)</span></div>
         <div class='mb-1'><input type="checkbox" name='isbformcorrect' value='1' class='chk' checked> &nbsp &nbsp B Form correct? <span class='txt-s'>(optional)</span></div>
         <div class=''><input type="checkbox" name='ismarkscorrect' value='1' class='chk' checked> &nbsp &nbsp Matric marks correct? <span class='txt-s'>(optional)</span></div>
      </div>
   </div>
