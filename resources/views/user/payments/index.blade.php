...
<div class="frow centered">
   <div class="fcol w-50 h-70 centered">
      <a href="{{route('payments.show',1)}}" class="frow w-100 py-2 my-3 text-primary border-1 border-left border-success" style="background-color: #eee;">
         <div class="fcol centered w-10"><i data-feather='users' class="feather-xsmall"></i></div>
         <div class="txt-m">Sellers Payments</div>
      </a>
      <a href="{{route('payments.show',2)}}" class="frow w-100 py-2 my-3 text-primary border-1 border-left border-success" style="background-color: #eee;">
         <div class="fcol centered w-10"><i data-feather='users' class="feather-xsmall"></i></div>
