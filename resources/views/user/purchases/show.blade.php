   ...
   <div class="fcol w-80">
      ...
      <div class="bg-custom-light p-4">
         ...
         <div class="frow stretched px-2 my-2 tr">
            ...
            <div class="frow w-10 centered">
               <form action="{{url('wastes/create',$store->id}}" method="POST" id='del_form{{$deal->id}}'>
                  @csrf
                  @method('DELETE')
                  <button type="submit" class="bg-transparent p-0 border-0" onclick="delme('{{$deal->id}}')"><i data-feather='trash' class="feather-xsmall mx-1 txt-red"></i></button>
               </form>
