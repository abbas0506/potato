<div>
   ...
   <div id='menu-container'>
      ...
      <div class="flexrow row-mid-left txt-m mb-2"><a href="{{url('sections')}}"><i data-feather='pie-chart' class="feather-xsmall mx-4"></i>Sections </a></div>
      ...
      <div class="collapse pl-4 my-2" id='collapse_section' data-parent='#menu-container'>
         <div class="flexrow row-mid-left txt-s"><a href="{{url('sections')}}"><i data-feather='plus' class="feather-xsmall mx-4"></i>View All</a></div>
         <div class="flexrow row-mid-left txt-s"><a href="{{url('viewAssignSection')}}"><i data-feather='plus' class="feather-xsmall mx-4"></i>Assign Student</a></div>
         <div class="flexrow row-mid-left txt-s"><a href="{{url('viewDetachSection')}}"><i data-feather='x' class="feather-xsmall mx-4"></i>Remove From Section </a></div>
      </div> -->
